...
(function() {
  ...
  SplashView = (function(_super) {
    ...
    SplashView.prototype.doLayout = function() {
      ...
      return this.setButton(7, "OPTIONS");
    };
  ...
  Validate = (function() {
    ...
    Validate.run = function() {
      var creature, feature, idSet, item, location, locationSet, map, name, spell, target, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
  ...
  Gurk = (function() {
    ...
    Gurk.prototype.phoneClick = function(e) {
      return this.buttonGrid.clicked(document.getElementById("controlID").relMouseCoords(e));
    };
